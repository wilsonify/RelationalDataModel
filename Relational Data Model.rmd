...
a collection of operators (e.g., difference, or MINUS) that can be applied to relations
...
```
project tuples of the form (ingredient, quantity) restrict to bacon or eggs
```
